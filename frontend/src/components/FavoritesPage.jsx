        ...
        <div className="bg-gradient-to-r via-green-50 from-blue-50 to-yellow-50">
            ...
            <header className="absolute inset-x-0 top-3 z-50">
                ...
                >
                    ...
                    <DialogPanel
                        className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gradient-to-r via-green-50 from-blue-50 to-yellow-50 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
                            ...
                            <div className="-my-6 divide-y divide-gray-500/10">
                                <div className="py-6">
                                    <div
                                        ...
                                        <p className="text-center font-macondo text-xl">"The world is a book, and those
                                            who do not travel read only one page."</p>
                                        <p className="text-center mt-2 text-sm font-caveat">– Saint Augustine -</p>
            ...
            <div className="relative">
                ...
                <div className="absolute inset-0 flex items-center justify-center sm:mt-0 mt-[500px]">
                    <div className="mx-auto max-w-7xl px-6 lg:px-8 py-32 text-center">
                        <h1 className="sm:text-7xl text-5xl font-bold tracking-tight sm:text-gray-600 text-black drop-shadow-lg font-caveat">
