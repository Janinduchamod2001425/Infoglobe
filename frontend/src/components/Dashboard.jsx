          ...
          <div className="hidden lg:flex lg:flex-1 lg:justify-end mr-60">
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className="text-md text-gray-500 hover:text-gray-700 font-macondo font-bold sm:mt-1"
              >
                Logout
              </button>
            </div>
        ...
        >
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-white px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
              ...
              >
                <XMarkIcon aria-hidden="true" className="size-6  p-5" />
              </button>
            </div>
                ...
                <div className="py-6">
                  <div className="-mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold text-gray-900">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={handleLogout}
                        className="text-sm text-white py-1 px-4 bg-blue-500 rounded-full hover:text-gray-700 mr-4"
                      >
                        Logout
                      </button>
                    </div>
